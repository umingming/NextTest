            ...
            <div className="mt-16 px-4">
                ...
                <form className="flex flex-col mt-8">
                    ...
                    <div className="mt-1">
                        ...
                        {method === "Phone" ? (
                            <div className="flex rounded-md shodw-sm">
                                <span
                                    className="
                                        flex items-center justify-center px-3 select-none rounded-l-md border border-r-0 
                                ...
                                <input
                                    type="number"
                                    className="
                                        appearance-none w-full px-4 py-2 border border-gray-300 rounded-md rounded-l-none shadow-sm placeholder-gray-400
                                        focus:outline-none focus:ring-orange-500 focus:border-orange-500
                                    "
                                    required
                                />
                    ...
                    <button
                        className="
                            mt-6 py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium
