...
export const ROUTE_CONFIGS: RouteConfig[] = [
    ...
    {
        [ROUTE_KEY.PATH]: "/community",
        [ROUTE_KEY.TITLE]: "동네생활",
        [ROUTE_KEY.ICON]:
...
export const ROUTE_CONFIG_MAP = ROUTE_CONFIGS.reduce(
    (acc, cur) => {
        acc[cur[ROUTE_KEY.PATH]] = cur[ROUTE_KEY.TITLE];
        return acc;
    },
